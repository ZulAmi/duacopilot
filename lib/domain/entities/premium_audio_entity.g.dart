...
_$PremiumPlaylistImpl _$$PremiumPlaylistImplFromJson(
    ...
    _$PremiumPlaylistImpl(
      ...
      recitationIds: (json['recitationIds'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
      mood: $enumDecodeNullable(_$PlaylistMoodEnumMap, json['mood']) ??
...
_$SleepTimerConfigImpl _$$SleepTimerConfigImplFromJson(
    ...
    _$SleepTimerConfigImpl(
      ...
      action: $enumDecodeNullable(_$SleepActionEnumMap, json['action']) ??
          SleepAction.pause,
      fadeOut: $enumDecodeNullable(_$FadeOutDurationEnumMap, json['fadeOut']) ??
...
_$PremiumAudioSettingsImpl _$$PremiumAudioSettingsImplFromJson(
    ...
    _$PremiumAudioSettingsImpl(
      ...
      crossfadeDuration: json['crossfadeDuration'] == null
      ...
      unusedContentRetention: json['unusedContentRetention'] == null
...
_$PremiumAudioStatsImpl _$$PremiumAudioStatsImplFromJson(
    ...
    _$PremiumAudioStatsImpl(
      ...
      qariPreferences: (json['qariPreferences'] as Map<String, dynamic>?)?.map(
            (k, e) => MapEntry(k, (e as num).toInt()),
          ) ??
          const {},
      moodPreferences: (json['moodPreferences'] as Map<String, dynamic>?)?.map(
            (k, e) => MapEntry(
                $enumDecode(_$PlaylistMoodEnumMap, k), (e as num).toInt()),
          ) ??
          const {},
      topRecitations: (json['topRecitations'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
...
Map<String, dynamic> _$$PremiumAudioStatsImplToJson(
    ...
    <String, dynamic>{
      ...
      'moodPreferences': instance.moodPreferences
          .map((k, e) => MapEntry(_$PlaylistMoodEnumMap[k]!, e)),
