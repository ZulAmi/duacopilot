...
_$SmartDuaCollectionImpl _$$SmartDuaCollectionImplFromJson(
  ...
  primaryEmotion: $enumDecode(_$EmotionalStateEnumMap, json['primaryEmotion']),
  secondaryEmotions:
...
_$EmotionalPatternImpl _$$EmotionalPatternImplFromJson(
  ...
  userId: json['userId'] as String,
  dominantEmotion: $enumDecode(
    _$EmotionalStateEnumMap,
    json['dominantEmotion'],
  ),
  emotionFrequency: (json['emotionFrequency'] as Map<String, dynamic>).map(
    (k, e) => MapEntry(
      $enumDecode(_$EmotionalStateEnumMap, k),
      (e as num).toDouble(),
    ),
  ),
  contextPreferences: (json['contextPreferences'] as Map<String, dynamic>).map(
    (k, e) => MapEntry($enumDecode(_$DuaContextEnumMap, k), (e as num).toInt()),
  ),
  frequentTriggers:
      (json['frequentTriggers'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
  ...
  predictionAccuracy: (json['predictionAccuracy'] as num?)?.toDouble() ?? 0.0,
);
...
Map<String, dynamic> _$$EmotionalPatternImplToJson(
  ...
  'emotionFrequency': instance.emotionFrequency.map(
    (k, e) => MapEntry(_$EmotionalStateEnumMap[k]!, e),
  ),
  'contextPreferences': instance.contextPreferences.map(
    (k, e) => MapEntry(_$DuaContextEnumMap[k]!, e),
  ),
...
_$SmartDuaRecommendationImpl _$$SmartDuaRecommendationImplFromJson(
  ...
  targetEmotion: $enumDecode(_$EmotionalStateEnumMap, json['targetEmotion']),
  context: $enumDecode(_$DuaContextEnumMap, json['context']),
  matchedKeywords:
...
_$ContextualInputImpl _$$ContextualInputImplFromJson(
  ...
  processedKeywords:
      (json['processedKeywords'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
  detectedEmotion: $enumDecode(
    _$EmotionalStateEnumMap,
    json['detectedEmotion'],
  ),
  detectedContext: $enumDecode(_$DuaContextEnumMap, json['detectedContext']),
...
_$ContextualAnalyticsImpl _$$ContextualAnalyticsImplFromJson(
  ...
  userId: json['userId'] as String,
  emotionSuccessRate: (json['emotionSuccessRate'] as Map<String, dynamic>).map(
    (k, e) =>
        MapEntry($enumDecode(_$EmotionalStateEnumMap, k), (e as num).toInt()),
  ),
  contextEffectiveness: (json['contextEffectiveness'] as Map<String, dynamic>)
      .map(
        (k, e) => MapEntry(
          $enumDecode(_$DuaContextEnumMap, k),
          (e as num).toDouble(),
        ),
      ),
  ...
  dismissedRecommendations: (json['dismissedRecommendations'] as num).toInt(),
...
Map<String, dynamic> _$$ContextualAnalyticsImplToJson(
  ...
  'userId': instance.userId,
  'emotionSuccessRate': instance.emotionSuccessRate.map(
    (k, e) => MapEntry(_$EmotionalStateEnumMap[k]!, e),
  ),
  'contextEffectiveness': instance.contextEffectiveness.map(
    (k, e) => MapEntry(_$DuaContextEnumMap[k]!, e),
  ),
