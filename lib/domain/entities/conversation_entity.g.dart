...
_$UserProfileImpl _$$UserProfileImplFromJson(Map<String, dynamic> json) =>
    _$UserProfileImpl(
      ...
      topicInterests:
          (json['topicInterests'] as List<dynamic>)
              .map((e) => e as String)
              .toList(),
...
_$ConversationContextImpl _$$ConversationContextImplFromJson(
  ...
  emotionalState: $enumDecode(_$EmotionalStateEnumMap, json['emotionalState']),
  contextTags:
...
const _$EmotionalStateEnumMap = {
  ...
  EmotionalState.seeking_guidance: 'seeking_guidance',
...
_$ConversationTurnImpl _$$ConversationTurnImplFromJson(
  ...
  semanticEmbedding:
      (json['semanticEmbedding'] as List<dynamic>)
...
_$SemanticMemoryImpl _$$SemanticMemoryImplFromJson(
  Map<String, dynamic> json,
...
_$ConversationUpdateImpl _$$ConversationUpdateImplFromJson(
  ...
  updateType: $enumDecode(_$ConversationUpdateTypeEnumMap, json['updateType']),
);
...
_$ConversationStatsImpl _$$ConversationStatsImplFromJson(
  ...
  mostDiscussedTopics:
      (json['mostDiscussedTopics'] as List<dynamic>)
          .map((e) => TopicFrequency.fromJson(e as Map<String, dynamic>))
          .toList(),
  lastConversationDate:
      json['lastConversationDate'] == null
          ? null
...
_$CalendarEventImpl _$$CalendarEventImplFromJson(Map<String, dynamic> json) =>
    _$CalendarEventImpl(
      ...
      metadata: json['metadata'] as Map<String, dynamic>,
      suggestedDuas:
          (json['suggestedDuas'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList(),
    );
