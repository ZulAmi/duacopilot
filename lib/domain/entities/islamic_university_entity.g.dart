...
_$IslamicScholarImpl _$$IslamicScholarImplFromJson(Map<String, dynamic> json) =>
...
_$PremiumCourseImpl _$$PremiumCourseImplFromJson(Map<String, dynamic> json) =>
    _$PremiumCourseImpl(
      ...
      averageCompletionTime: json['averageCompletionTime'] == null
          ? Duration.zero
          : Duration(
      ...
      certificateType: $enumDecodeNullable(
              _$CertificationTypeEnumMap, json['certificateType']) ??
...
_$CourseLessonImpl _$$CourseLessonImplFromJson(Map<String, dynamic> json) =>
    _$CourseLessonImpl(
      ...
      averageWatchTime: json['averageWatchTime'] == null
          ? Duration.zero
...
_$IslamicQuizImpl _$$IslamicQuizImplFromJson(Map<String, dynamic> json) =>
    _$IslamicQuizImpl(
      id: json['id'] as String,
      title: json['title'] as String,
      description: json['description'] as String,
...
_$LiveQASessionImpl _$$LiveQASessionImplFromJson(Map<String, dynamic> json) =>
    _$LiveQASessionImpl(
      id: json['id'] as String,
      title: json['title'] as String,
      description: json['description'] as String,
...
_$PersonalizedCurriculumImpl _$$PersonalizedCurriculumImplFromJson(
    ...
    _$PersonalizedCurriculumImpl(
      ...
      pathIds:
          (json['pathIds'] as List<dynamic>).map((e) => e as String).toList(),
      courseIds:
          (json['courseIds'] as List<dynamic>).map((e) => e as String).toList(),
      ...
      goals: (json['goals'] as List<dynamic>?)
              ...
              .toList() ??
          const [],
      status: $enumDecodeNullable(_$CurriculumStatusEnumMap, json['status']) ??
      ...
      recommendedCourses: (json['recommendedCourses'] as List<dynamic>?)
              ...
              .toList() ??
          const [],
      recommendedScholars: (json['recommendedScholars'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
      lastRecommendationUpdate: json['lastRecommendationUpdate'] == null
          ? null
...
_$IslamicCertificateImpl _$$IslamicCertificateImplFromJson(
    ...
    _$IslamicCertificateImpl(
      ...
      skillsEarned: (json['skillsEarned'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
...
_$LearningAnalyticsImpl _$$LearningAnalyticsImplFromJson(
    ...
    _$LearningAnalyticsImpl(
      ...
      categoryProgress: (json['categoryProgress'] as Map<String, dynamic>?)
              ?.map(
            (k, e) => MapEntry(
                $enumDecode(_$CourseCategoryEnumMap, k), (e as num).toInt()),
          ) ??
          const {},
      scholarInteractions:
      ...
      favoriteTopics: (json['favoriteTopics'] as List<dynamic>?)
              ...
              .toList() ??
          const [],
      firstStudyDate: json['firstStudyDate'] == null
          ? null
...
Map<String, dynamic> _$$LearningAnalyticsImplToJson(
    ...
    <String, dynamic>{
      ...
      'categoryProgress': instance.categoryProgress
          .map((k, e) => MapEntry(_$CourseCategoryEnumMap[k]!, e)),
