...
_$EnhancedRecommendationImpl _$$EnhancedRecommendationImplFromJson(
  ...
  contextTags:
      (json['contextTags'] as List<dynamic>).map((e) => e as String).toList(),
  confidence: (json['confidence'] as num).toDouble(),
  isPersonalized: json['isPersonalized'] as bool? ?? false,
  enhancementReasons:
      (json['enhancementReasons'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
...
_$PersonalizationScoreImpl _$$PersonalizationScoreImplFromJson(
  ...
  customScores:
      (json['customScores'] as Map<String, dynamic>?)?.map(
...
_$UserSessionImpl _$$UserSessionImplFromJson(Map<String, dynamic> json) =>
    _$UserSessionImpl(
      ...
      interactions:
          ...
          const [],
      duaViews:
          (json['duaViews'] as Map<String, dynamic>?)?.map(
...
_$UsagePatternsImpl _$$UsagePatternsImplFromJson(
  Map<String, dynamic> json,
) => _$UsagePatternsImpl(
  userId: json['userId'] as String,
  frequentDuas:
      (json['frequentDuas'] as List<dynamic>).map((e) => e as String).toList(),
  recentDuas:
      (json['recentDuas'] as List<dynamic>).map((e) => e as String).toList(),
  categoryPreferences: Map<String, int>.from(
    json['categoryPreferences'] as Map,
  ),
  timeOfDayPatterns: (json['timeOfDayPatterns'] as Map<String, dynamic>).map(
    (k, e) => MapEntry(k, (e as num).toDouble()),
  ),
...
_$CulturalPreferencesImpl _$$CulturalPreferencesImplFromJson(
  ...
  culturalTags:
      (json['culturalTags'] as List<dynamic>).map((e) => e as String).toList(),
  languagePreferences: (json['languagePreferences'] as Map<String, dynamic>)
      .map((k, e) => MapEntry(k, (e as num).toDouble())),
  lastUpdated: DateTime.parse(json['lastUpdated'] as String),
  customPreferences:
      json['customPreferences'] as Map<String, dynamic>? ?? const {},
  autoDetectLanguage: json['autoDetectLanguage'] as bool? ?? false,
  transliterationStyle: json['transliterationStyle'] as String? ?? 'balanced',
);
...
_$CulturalPreferenceUpdateImpl _$$CulturalPreferenceUpdateImplFromJson(
  ...
  primaryLanguage: json['primaryLanguage'] as String?,
  culturalTags:
      (json['culturalTags'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
  languagePreferences: (json['languagePreferences'] as Map<String, dynamic>?)
      ?.map((k, e) => MapEntry(k, (e as num).toDouble())),
...
_$TemporalPatternsImpl _$$TemporalPatternsImplFromJson(
  ...
  hourlyPatterns: (json['hourlyPatterns'] as Map<String, dynamic>).map(
    (k, e) => MapEntry(
      int.parse(k),
      HourlyPattern.fromJson(e as Map<String, dynamic>),
    ),
  ),
  dayOfWeekPatterns: (json['dayOfWeekPatterns'] as Map<String, dynamic>).map(
    (k, e) => MapEntry(k, DayOfWeekPattern.fromJson(e as Map<String, dynamic>)),
  ),
  seasonalPatterns: (json['seasonalPatterns'] as Map<String, dynamic>).map(
    (k, e) => MapEntry(k, SeasonalPattern.fromJson(e as Map<String, dynamic>)),
  ),
  ...
  prayerTimePatterns:
      ...
      const {},
  habitStrengths:
      (json['habitStrengths'] as Map<String, dynamic>?)?.map(
        (k, e) => MapEntry(k, (e as num).toDouble()),
      ) ??
      const {},
);
...
Map<String, dynamic> _$$TemporalPatternsImplToJson(
  ...
  'userId': instance.userId,
  'hourlyPatterns': instance.hourlyPatterns.map(
...
_$HourlyPatternImpl _$$HourlyPatternImplFromJson(
  Map<String, dynamic> json,
) => _$HourlyPatternImpl(
  hour: (json['hour'] as num).toInt(),
  popularDuas:
      (json['popularDuas'] as List<dynamic>).map((e) => e as String).toList(),
  activityScore: (json['activityScore'] as num).toDouble(),
  categoryFrequency: Map<String, int>.from(json['categoryFrequency'] as Map),
  totalInteractions: (json['totalInteractions'] as num?)?.toInt() ?? 0,
);
...
_$DayOfWeekPatternImpl _$$DayOfWeekPatternImplFromJson(
  ...
  preferredDuas:
      (json['preferredDuas'] as List<dynamic>).map((e) => e as String).toList(),
...
_$SeasonalPatternImpl _$$SeasonalPatternImplFromJson(
  ...
  seasonalDuas:
      (json['seasonalDuas'] as List<dynamic>).map((e) => e as String).toList(),
  relevanceScore: (json['relevanceScore'] as num).toDouble(),
  occasionFrequency: Map<String, int>.from(json['occasionFrequency'] as Map),
  specialOccasions:
      (json['specialOccasions'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
);
...
_$PersonalizationContextImpl _$$PersonalizationContextImplFromJson(
  ...
  timestamp: DateTime.parse(json['timestamp'] as String),
  usagePatterns: UsagePatterns.fromJson(
    json['usagePatterns'] as Map<String, dynamic>,
  ),
...
_$PersonalizationInputImpl _$$PersonalizationInputImplFromJson(
  ...
  query: json['query'] as String,
  candidateDuas:
      (json['candidateDuas'] as List<dynamic>)
...
_$ContextualSuggestionInputImpl _$$ContextualSuggestionInputImplFromJson(
  ...
  userId: json['userId'] as String,
  timestamp: DateTime.parse(json['timestamp'] as String),
  islamicContext: TimeContext.fromJson(
    json['islamicContext'] as Map<String, dynamic>,
  ),
  ...
  locationSuggestions:
      (json['locationSuggestions'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
